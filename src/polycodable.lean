...
begin
  ...
  { ext b₁, cases b₁; simp, },
  apply polytime_fun.ite', apply polytime_fun.fst, apply polytime_fun.snd, apply polytime_fun.const,
end
...
begin
  ...
  { ext b₁, cases b₁; simp, },
  apply polytime_fun.ite' polytime_fun.fst (polytime_fun.const _) polytime_fun.snd, 
end

lemma polytime_fun.bnot : polytime_fun bnot :=
by { convert_to polytime_fun (λ b, cond b ff tt), { ext b, cases b; refl, }, apply polytime_fun.ite' polytime_fun.id; apply polytime_fun.const, }
...
begin
  apply polytime_fun.comp₂ polytime_fun.band, { simp, apply polytime_fun.comp polytime_fun.bnot, apply polytime_fun.eq_nil_aux, },
  apply polytime_fun.comp₂ polytime_fun.band, apply polytime_fun.comp hf, apply polytime_fun.ptree_left, apply polytime_fun.comp hg, apply polytime_fun.ptree_right,
end
